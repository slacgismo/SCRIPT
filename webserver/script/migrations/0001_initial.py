# Generated by Django 2.2.4 on 2020-04-20 14:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('aggregation_level', 'num_evs', 'choice', 'fast_percent', 'work_percent', 'res_percent', 'l1_percent', 'public_l2_percent')},
            },
        ),
        migrations.CreateModel(
            name='Vehicle',
        ...
        migrations.CreateModel(
            name='ZipCode',
            fields=[
                ('code', models.CharField(max_length=5, primary_key=True, serialize=False, validators=[script.validators.validate_zipcode])),
                ('county', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.County')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lf_config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.LoadForecastConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zipcode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.ZipCode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.Driver')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.ChargingStation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.ChargingSession')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('npv', django.contrib.postgres.fields.jsonb.JSONField()),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.NetPresentValueConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('loads', django.contrib.postgres.fields.jsonb.JSONField()),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.LoadProfileConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.LoadForecastConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.LoadControllerConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('consumption', django.contrib.postgres.fields.jsonb.JSONField()),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.GasConsumptionConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emissions', django.contrib.postgres.fields.jsonb.JSONField()),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.EmissionConfig')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cost_benefit', django.contrib.postgres.fields.jsonb.JSONField()),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='script.CostBenefitConfig')),
            ],
            options={
