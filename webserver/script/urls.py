...
from script.views import CountyViewSet, EnergyViewSet, EnergyView, ChargingStationViewSet
...
router.register('charging_station', ChargingStationViewSet, 'charging_station')
